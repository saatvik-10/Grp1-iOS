...
final class GamesInfoModalViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard let sectionType = Section(rawValue: indexPath.section), sectionType == .howToPlay else { return }
...
final class GameHowToPlayViewController: UIViewController {
